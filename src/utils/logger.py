...
FORMAT_CONFIG['curl_conservative'] = copy.deepcopy(FORMAT_CONFIG['sac'])
FORMAT_CONFIG['curl_conservative']['train'].append(('curl_loss', 'CU_LOSS', 'float'))
FORMAT_CONFIG['curl_conservative']['train'].append(('conservative_loss', 'CONS_LOSS', 'float'))
FORMAT_CONFIG['curl_conservative']['train'].append(('combined_loss', 'COMB_LOSS', 'float'))
FORMAT_CONFIG['curl_conservative']['train'].append(('alpha_prime_loss', 'CU_LOSS', 'float'))
